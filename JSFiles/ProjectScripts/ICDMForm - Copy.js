...
function GetApproverMaster() {
    $.ajax
        ({
            url: _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/GetByTitle('ApproverMaster')/items",
            type: "GET",
            async: false,
            headers:
            {
    ...
    if (listDataArray != null) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                SaveLocalApprovalMatrix(itemID,listname,ItemCodeApprovalMatrixListName);
